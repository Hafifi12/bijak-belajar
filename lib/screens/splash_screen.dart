...
class _SplashScreenState extends State<SplashScreen>
  ...
  void initState() {
    ...
    _mascotScale = Tween<double>(begin: 0.55, end: 1.0).animate(
      CurvedAnimation(
        parent: _entryCtrl,
    ...
    return List.generate(positions.length, (i) {
      ...
      return Positioned(
        ...
        child: Opacity(
          ...
          child: Text(
            emojis[i],
            style: TextStyle(fontSize: 14 + (i % 3) * 5.0),
          ),
        ),
      );
    });
      ...
      children: [
        ShaderMask(
          shaderCallback: (b) => const LinearGradient(
            colors: [AppTheme.sunnyYellow, Color(0xFFFFE066)],
          ).createShader(b),
          child: const Text(
            'Bijak',
            style: TextStyle(
            ...
            Container(
              ...
              decoration: BoxDecoration(
                gradient: const LinearGradient(
                  colors: [Color(0xFFFFD21E), Color(0xFFFFC107)],
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      Row(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: const [_Eye(), SizedBox(width: 18), _Eye()],
                      ),
...
class _SmilePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawArc(
      Rect.fromLTWH(4, 0, size.width - 8, size.height + 4),
      0.2,
      math.pi - 0.4,
      false,
      paint,
      ...
      child: GestureDetector(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: [
              BoxShadow(
                color: AppTheme.sunnyYellow.withValues(alpha: 0.7),
                blurRadius: 28,
                spreadRadius: 2,
...
class _HillPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    final paint = Paint()
      ..color = const Color(0xFFE3F2FD).withValues(alpha: 0.18);
    final path = Path()
