...
class MathPracticeScreen extends StatelessWidget {
  ...
  static const _topics = [
    ...
    _MathTopic(
      ...
      subtitleMs: 'Sifir 1 hingga 12',
      subtitleEn: 'Times tables 1 to 12',
      op: MathOp.multiply,
    ...
    _MathTopic(
      labelMs: 'Bahagi ➗',
      labelEn: 'Division ➗',
      subtitleMs: 'Latihan bahagi dengan baki',
      subtitleEn: 'Practice dividing numbers',
      op: MathOp.divide,
                ...
                children: [
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        Text(
                          isMalay ? 'Matematik Sekolah Rendah' : 'Primary School Maths',
          ...
          .map(
            (l) => Expanded(
              child: Container(
                ...
                child: Column(
                  children: [
                    Text(isMalay ? l.label : l.labelEn,
                        style: TextStyle(
                          fontSize: 11,
    ...
    return Material(
      ...
      child: InkWell(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            borderRadius: BorderRadius.circular(20),
            border: Border.all(color: topic.color.withValues(alpha: 0.3), width: 2),
          ),
          child: Row(
            children: [
              Container(
...
class _MathQuizScreenState extends State<MathQuizScreen>
  ...
  void initState() {
    ...
    _popAnim = Tween<double>(begin: 0.7, end: 1.0).animate(
      ...
      body: SafeArea(
        child: Column(
          children: [
              ...
              child: Row(
                children: List.generate(_totalQuestions, (i) {
                  ...
                  if (i < _answers.length) {
                    dotColor = _answers[i] ? Colors.green : Colors.red;
            ...
            Text(
              '${isMalay ? 'Soalan' : 'Question'} ${_questionIndex + 1} / $_totalQuestions',
              style: TextStyle(
                  fontSize: 13,
                  fontWeight: FontWeight.bold,
                  color: color),
                    ...
                    Expanded(
                      child: ElevatedButton.icon(
                        onPressed: () => Navigator.of(context)
                            .popUntil((r) => r.settings.name == MathPracticeScreen.routeName || r.isFirst),
  ...
  factory _Question.generate({
    ...
    switch (effectiveOp) {
      ...
      case MathOp.subtract:
        ...
        hint = '';
      case MathOp.multiply:
        final maxT = [5, 10, 12][level - 1];
        a = rng.nextInt(maxT) + 1;
    ...
    while (opts.length < 4) {
      ...
      opts.add(rng.nextBool() ? answer + delta : (answer - delta).abs().clamp(0, 999));
    }
